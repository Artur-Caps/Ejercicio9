...
import com.mexiti.catphotoapp.network.CatApi.retrofitService
...
class CatViewModel(catPhotoRepository: CatPhotoRepository) :ViewModel(){
   ...
   private  fun getCatPhotos(){
         viewModelScope.launch {
            catUiState = try {
                 val catPhotoRepository = NetworkCatPhotoRepository(retrofitService)
